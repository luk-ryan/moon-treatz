...
export const weeklySpecials: WeeklyFlavour[] = [
  ...
  {
    id: 16,
    flavours: ["Strawberry Cheesecake", "Chocolate", "Mint Chocolate"],
    displayImage: "/flavours/weekly_specials/transparent/weekly_special_16.png",
    images: [
      "/flavours/weekly_specials/weekly_special_16(box-view).jpg",
      "/flavours/weekly_specials/weekly_special_16(box-view2).jpg",
  ...
  {
    id: 20,
    flavours: ["Tiramisu", "Salted Caramel", "Red Velvet"],
    displayImage: "/flavours/weekly_specials/transparent/weekly_special_20.jpg",
    images: [
      "/flavours/weekly_specials/weekly_special_20(box-view).jpg",
      "/flavours/weekly_specials/weekly_special_20(box-view2).jpg",
