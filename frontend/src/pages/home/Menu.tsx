    ...
    <div>
      ...
      <div className="narrow-wrapper">
        ...
        <div className="order-instructions">
          ...
          <p><em>* Keep macaron box orders refrigerated.*</em></p>
          <p>
          ...
          <p>Both <strong>Pickup</strong> and <strong>Delivery</strong> options are available:</p>
          <ul>
            <li>
              <strong>Pickup</strong> will be at our location listed below (exact address will be
              given out upon ordering).
            </li>
            <li><strong>Delivery fee</strong> of $2 - $5</li>
          </ul>
          <p>Available Payment Options: <strong>Cash</strong> and <strong>E-transfer</strong></p>
        </div>
      </div>
    </div>
  );
